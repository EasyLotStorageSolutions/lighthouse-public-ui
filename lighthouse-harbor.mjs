...
storyLead.append(el('p','harbor-eyebrow','What Lighthouse offers'),storyTitle,el('p',null,'Lighthouse brings practical parts of everyday life into one connected community. The Marketplace has places for vehicles, equipment, household goods, business assets, free items, trades, wanted posts, and reviewed auctions. Makers Market & Community gives handmade goods, custom work, repairs, prototypes, and maker connections a place of their own. Towing & Roadside Assistance focuses on roadside and vehicle-moving help. Contractors & Home Services focuses on property projects and professional trades. Storage & Space helps people describe what they need and connect with a fitting space. Jobs & Hiring brings workers, employers, and opportunities together. Each store stays focused on its own purpose.'));
...
const {mountMallMap}=await import('./lighthouse-mall-map.mjs?v=20260909-mobile-map1');
